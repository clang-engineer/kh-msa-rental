...
import com.hhkbdev.rental.config.ApplicationProperties
import com.hhkbdev.rental.config.CRLFLogConverter
...
class RentalApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<RentalApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(RentalApp::class.java)
