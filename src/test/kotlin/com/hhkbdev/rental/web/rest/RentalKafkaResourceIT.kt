...
import com.hhkbdev.rental.config.KafkaSseConsumer
import com.hhkbdev.rental.config.KafkaSseProducer
...
class RentalKafkaResourceIT {
    ...
    fun producesMessages() {
        client.post().uri("/api/rental-kafka/publish?message=value-produce")
            .exchange()
            .expectStatus()
            .isNoContent
